...
void MA8451_Pins(void)
{
    ...
    GPIO_PinInit(MA8451_PINS_ACCEL_IRQ_8_GPIO, MA8451_PINS_ACCEL_IRQ_8_PIN, &ACCEL_IRQ_8_config);
    ...
    PORT_SetPinConfig(MA8451_PINS_ACCEL_IRQ_8_PORT, MA8451_PINS_ACCEL_IRQ_8_PIN, &ACCEL_IRQ_8);
}
/***********************************************************************************************************************
 * EOF
 **********************************************************************************************************************/
